       ...
       <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="bg-white rounded-2xl shadow p-6 flex flex-col gap-4">
            ...
            <x-custom-input-form label="Satuan" name="satuan" type="select" required="true" :options="['Pcs','Box','Kg','Lusin','Liter']" placeholder="Pilih Satuan" />
          ...
          <div class="bg-white rounded-2xl shadow p-6 flex flex-col gap-4">
            ...
            <x-custom-input-form label="Kategori" name="kategori" type="select" :options="['Barang','Jasa']" placeholder="Pilih Kategori" />
