...
>
  <main class="main-container scrollbar-hidden">
    ...
    <!-- Main Flex -->
    <div class="flex gap-[1rem] h-[516px]" data-aos="fade-right" data-aos-delay="300">
          ...
          <div>
            ...
            <div class="flex items-end justify-between w-full mt-2">
              ...
              <div class="flex flex-col items-end">
                @php
                  $isIncomeNegative = isset($percent) && floatval($percent) < 0;
                @endphp
                <span class="flex items-center font-bold text-lg {{ $isIncomeNegative ? 'text-red-500' : 'text-green-500' }}">
                  @if($isIncomeNegative)
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M480-80 200-360l56-56 184 183v-647h80v647l184-184 56 57L480-80Z"/></svg>
                  @else
      ...
      <div class="flex flex-col flex-auto gap-[1rem]">
        ...
        <div class="bg-white rounded-2xl shadow p-4 flex flex-col">
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex flex-col items-end">
              @php
                $isProfitNegative = isset($profitPercent) && floatval($profitPercent) < 0;
              @endphp
              <span class="flex items-center font-bold text-lg {{ $isProfitNegative ? 'text-red-500' : 'text-green-500' }}">
                @if($isProfitNegative)
                  <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M480-80 200-360l56-56 184 183v-647h80v647l184-184 56 57L480-80Z"/></svg>
                @else
                  <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 10l7-7m0 0l7 7m-7-7v18"/></svg>
        ...
        <div class="bg-white rounded-2xl shadow p-4 flex flex-col h-full">
          <div class="flex items-center justify-between mb-[1rem]">
            ...
            <a href="/transaction/history?dashboard" class="text-primary text-xs w-full flex justify-end font-medium">Lihat semua &gt;</a>
          </div>
          <div class="w-full h-[1px] bg-gray-300 mb-[1rem]"></div>
